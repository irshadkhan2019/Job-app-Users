...
import { IOrderMessage, IRatingTypes, IReviewMessageDetails, ISellerDocument } from '@irshadkhan2019/job-app-shared';
...
//Note:If buyer was seperate service then we have to publish rabbitmq event and
// the buyer service will consume the msg and update the data. 
...
// based on orders of orders service
...
// update ratingCategory ,ratingCount,ratingsSum
...
// get string from key i.e data.rating ='5'then ratingkey='five'
